...
public:
    ...
    LegacyScriptPubKeyMan(WalletStorage& storage, uint64_t keypool_size) : ScriptPubKeyMan(storage), m_keypool_size(keypool_size) {}
...
public:
    DescriptorScriptPubKeyMan(WalletStorage& storage, WalletDescriptor& descriptor, uint64_t keypool_size)
        :   ScriptPubKeyMan(storage),
            m_keypool_size(keypool_size),
            m_wallet_descriptor(descriptor)
        {}
    DescriptorScriptPubKeyMan(WalletStorage& storage, uint64_t keypool_size)
        :   ScriptPubKeyMan(storage),
            m_keypool_size(keypool_size)
        {}
